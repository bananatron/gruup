...
var sendMessage = function(){
  ...
  switch(cmd) { //Maybe have this handled serverside as well for genuine admin check?
    case "help":
      ...
      if (admin == true) {
        msg += "<br><br>It also looks like you're an admin for this room (don't let the power get to your head). You can <b>/add</b> and <b>/remove</b> people from the channel,"
...
var notifyTags = function(msg){
  ...
  if (usrs ){
    usrs.forEach( function( username, ii ){
        ...
        var userNotices = new Firebase("https://gruupchat.firebaseio.com/users/" + username.replace('@','').trim() + "/notices/");
